    ...
    <div className="min-h-screen p-6 flex flex-col gap-6 max-w-7xl mx-auto relative overflow-hidden">
      ...
      <div className="flex justify-between items-center bg-surface/80 backdrop-blur-md p-4 rounded-2xl border border-border/50 shadow-sm z-10">
        ...
        <button
          ...
          className={`group relative flex items-center gap-2 px-6 py-2.5 rounded-xl font-medium text-sm transition-all overflow-hidden ${
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 flex-1 z-10">
        <div className="lg:col-span-2 bg-gradient-to-br from-surface to-background rounded-2xl border border-border/50 shadow-sm flex flex-col items-center justify-center p-8 relative overflow-hidden">
        ...
        <div className="flex flex-col gap-6">
          <div className="bg-gradient-to-br from-surface to-background p-6 rounded-2xl border border-border/50 shadow-sm flex-1 flex flex-col relative overflow-hidden group">
            ...
            <button
              onClick={handleCopy}
              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 border border-border rounded-xl text-primary hover:bg-background transition-colors font-medium text-sm relative z-10"
            >
              {copied ? (
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between p-6 bg-surface border border-border/50 rounded-2xl shadow-sm z-10">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <button className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl border border-[#0A66C2]/20 text-[#0A66C2] bg-[#0A66C2]/5 hover:bg-[#0A66C2]/10 transition-colors font-medium text-sm">
            <Share2 className="w-4 h-4" />
            Share Score
          </button>
          <button
            onClick={onRestart}
            className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl border border-border text-primary hover:bg-background transition-colors font-medium text-sm"
          >
